...
class KerasMnist(object):
    ...
    def build_model_no_skip(self):
        ...
        self.model.add(Dense(self.hidden_layer_dims[0], input_dim=self.input_dim, activation='relu'))
    ...
    def build_model_skip(self):
        ...
        out = Dense(self.hidden_layer_dims[0], activation='relu')(x)
        shortcut = out
        for i, dim in enumerate(self.hidden_layer_dims[1:]):
